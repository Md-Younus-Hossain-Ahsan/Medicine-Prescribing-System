...
public class Verify extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(Date, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 250, 230, -1));

        jSeparator1.setBackground(new java.awt.Color(0, 255, 255));
        jSeparator1.setForeground(new java.awt.Color(0, 153, 255));
        getContentPane().add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 130, 250, 20));

        Count_Down.setEditable(false);
        Count_Down.setBackground(new java.awt.Color(232, 245, 253));
        ...
        getContentPane().add(Count_Down, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 50, 130, 34));

        VerificationCode.setBackground(new java.awt.Color(232, 245, 253));
        ...
        getContentPane().add(VerificationCode, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 100, 250, 34));
        ...
        getContentPane().add(Back, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 180, 100, 40));

        Verify.setBackground(new java.awt.Color(232, 245, 253));
        Verify.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        Verify.setIcon(new javax.swing.ImageIcon(getClass().getResource("/background_images/verify icon.png"))); // NOI18N
        Verify.setText("Verify");
        Verify.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 153, 255)));
        ...
        getContentPane().add(Verify, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 180, 100, 40));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/background_images/bg3.jpg"))); // NOI18N
    ...
    private void VerifyMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_VerifyMouseClicked
        Verify.setBackground(new Color(0,0,255).brighter());
    ...
    private void VerifyMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_VerifyMouseEntered
        Verify.setBackground(new Color(0,153,255).brighter());
    ...
    private void VerifyMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_VerifyMouseExited
        Verify.setBackground(new Color(232,245,253));
        Verify.setForeground(Color.BLACK);
